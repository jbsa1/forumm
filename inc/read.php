        ...
        <div class="alert alert-info">
            ...
            Penulis : <a href="./?p=user&user=<?php echo $datapost["penulis_post"]; ?>">@<?php echo $datapost["penulis_post"]; ?></a> | Pada : <u><?php echo $datapost["tanggal_post"]; ?></u> <span style="float:right;"><i class="fa fa-thumbs-up"></i> : <?php echo $datapost["suka_post"]; ?>
                ...
                if (empty($_SESSION["user"])) {
                    echo "0";
                } else if ($datasukapost["post_suka"] == 1) {
                ?>
...
<div class="alert alert-warning">
    ...
    ?>
            ...
            <?php
            } else if (@$datakomentar["penulis_komentar"] == @$data2["user_user"]) {
            ?>
                <a href="./inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"]; ?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus Komentar Kamu?')">X</a>
            <?php
            } else if ($data2["level_user"] == 1) {
            ?>
                <a href="./inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"]; ?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus Komentar Ini?')">X</a>
            <?php
            }
            ?>
